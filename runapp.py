...
class Main( Login, Admin, User):
    ...
    def getdetails(self):
        ...
        self.cur.execute("CREATE TABLE if not exists todaysales(Trans_id integer (50) NOT NULL, product_name varchar (50),product_sprice NUMERIC NOT NULL, quantity INTEGER NOT NULL, total NUMERIC NOT NULL, Time varchar (20), pay_method varchar (50),cus_name varchar(32), cus_number varchar(32));")
        self.cur.execute(
        ...
        #addCol1 = "ALTER TABLE salesday ADD COLUMN cus_name varchar(32)"
        #self.cur.execute(addCol1)
       # addCol2 = "ALTER TABLE sales ADD COLUMN cus_name varchar(32)"
        #self.cur.execute(addCol2)

        #addCol3 = "ALTER TABLE salesday ADD COLUMN cus_number varchar(32)"
       # self.cur.execute(addCol3)
        #addCol4 = "ALTER TABLE sales ADD COLUMN cus_number varchar(32)"
        #self.cur.execute(addCol4)
    ...
    def buildmain(self):
        ...
        mi = Image.open("images/HEADER.png")
        mi = mi.resize((1300,60))
        ...
        self.myprofile.place(x=1230, y=4)
